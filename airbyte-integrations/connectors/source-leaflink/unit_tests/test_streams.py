...
import pytest
from source_leaflink.source import LeaflinkStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(LeaflinkStream, "path", "v0/example_endpoint")
    mocker.patch.object(LeaflinkStream, "primary_key", "test_primary_key")
    mocker.patch.object(LeaflinkStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = LeaflinkStream()
